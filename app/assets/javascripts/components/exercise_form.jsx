...
var ExerciseSelectedObjectives = React.createClass({
  ...
  render: function () {
    ...
    if (objectives.length) {
      var objectiveRows = objectives.map(function (objective) {
        return <ExerciseObjectiveRow key={'selected-obj-' + objective.id}
          objective={objective}
...
var ExerciseStandardsTable = React.createClass({
    ...
    this.props.standards.forEach(function (standard) {
      ...
      if (filtered.length) {
        var objectiveRows = filtered.map(function (objective) {
          return <ExerciseObjectiveRow key={'unselected-' + objective.id}
            objective={objective}
            objectiveRemoved={this.props.objectiveRemoved}
            objectiveAdded={this.props.objectiveAdded}
           />
...
var ExerciseObjectiveRow = React.createClass({
  add: function (e) {
  ...
  render: function () {
    ...
    if (this.props.objective.selected) {
      objectiveButton = <div>
        ...
        <input type="hidden" name="exercise[objective_ids][]" value={this.props.objective.id} />
      </div>
    } else {
